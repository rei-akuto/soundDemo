    ...
    public class Vive3DSPAudioSourceEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (bypassSmallSignal.boolValue == true)
            {
                ...
                EditorGUILayout.Slider(bypassSmallSignalValueDB, -96.0f, -60.0f, bypassSmallSignalValueDBLabel);
        ...
        private void checkAudioFileType()
        {
            ...
            if (model.audioSource == null) return;
        ...
        public void drawExportWavInspector()
        {
            ...
            EditorGUILayout.HelpBox("Export audio feature now supports only 16-bit PCM as input. Make sure that the AudioClip you select fits the format.", MessageType.Info);
