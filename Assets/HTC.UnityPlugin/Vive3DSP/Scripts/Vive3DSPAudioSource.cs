...
namespace HTC.UnityPlugin.Vive3DSP
{
    ...
    public class Vive3DSPAudioSource : MonoBehaviour
    {
        ...
        [SerializeField]
        private float bypassSmallSignalValueDB = -80.0f;
        ...
        void Update()
        {
            ...
            if (audioSource.spatialize)
            {
                ...
                audioSource.SetSpatializerFloat((int)EffectData.OcclusionEffectEngine, (float)OcclusionEffectEngine);
