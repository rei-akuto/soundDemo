...
namespace HTC.UnityPlugin.Vive3DSP
{
    ...
    public struct VIVE_3DSP_OCCLUSION_PROPERTY
    {
        ...
        public float radius;
        public float height;
        public OccGeometryMode mode;
        public OccComputeMode computeMode;
        public OccEffectEngine effectEngine;
    }
    ...
    public class Vive3DSPAudioNative
    {
        ...
        [DllImport(pluginName, EntryPoint = "vive_3dsp_ui_set_curve_param_plugin", CallingConvention = CallingConvention.Cdecl)]
        public static extern int vive_3dsp_ui_set_curve_param_plugin(float samplerate, bool useLogScale,
                                                           IntPtr filterEnable, IntPtr frequency, IntPtr gain, IntPtr Q);
        public Int32 Set3DSPUICurveParametric(float samplerate, bool useLogScale, IntPtr filterEnable,
        IntPtr frequency, IntPtr gain, IntPtr Q)
        {
            try
            {
                return vive_3dsp_ui_set_curve_param_plugin(samplerate, useLogScale, filterEnable, frequency, gain, Q);
            }
            catch (Exception e)
            {
                Debug.Log(e.ToString());
        ...
        [DllImport(pluginName, EntryPoint = "vive_3dsp_ui_get_curve_value_plugin", CallingConvention = CallingConvention.Cdecl)]
        public static extern int vive_3dsp_ui_get_curve_value_plugin(float[] outY, float inX);
        public Int32 Get3DSPUICurveValue(float[] outY, float inX)
        {
            try
            {
                return vive_3dsp_ui_get_curve_value_plugin(outY, inX);
            }
            catch (Exception e)
            {
                Debug.Log(e.ToString());
