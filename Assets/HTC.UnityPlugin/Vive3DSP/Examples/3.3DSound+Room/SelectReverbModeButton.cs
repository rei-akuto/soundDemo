    ...
    , IColliderEventHoverExitHandler
{
	...
	//[SerializeField]
 //   private SelectReverbModeButton m_onButton = null;
    [SerializeField]
    private Vive3DSPAudioSource m_viveAudioSource = null;
    [SerializeField]
        ...
        set
        {
            if (m_isOn != value)
            {
                ...
                if (value)
                {
                    ...
                    m_viveAudioSource.ReverbMode = ReverbMode.Binaural;
                ...
                else
                {
                    ...
                    m_viveAudioSource.ReverbMode = ReverbMode.Mono;
