...
{
    [SerializeField]
    private SoundDecayMode m_distanceMode = SoundDecayMode.NoDecay;
    [SerializeField]
    private SelectDisModeButtonGroup m_buttonGroup = null;
    [SerializeField]
    private Transform m_enabledObj = null;
    [SerializeField]
    private Transform m_disabledObj = null;
    [SerializeField]
        ...
        set
        {
            if (m_isOn != value)
            {
                ...
                if (value)
                {
                    ...
                    m_buttonGroup.audioSource.SoundDecayMode = m_distanceMode;
                }
                else
                {
    ...
    private void Update()
    {
        if (m_buttonGroup.audioSource.SoundDecayEffectSwitch)
        {
            //Debug.Log("m_buttonGroup.audioSource.distanceMode:" + m_buttonGroup.audioSource.distanceMode);
            if (m_buttonGroup.audioSource.SoundDecayMode == m_distanceMode)
            {
                isOn = true;
            }
            else
